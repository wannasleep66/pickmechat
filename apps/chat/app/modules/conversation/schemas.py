...
class ConversationDetailsOutSchema(ConversationReadSchema):
        ...
        *,
        ...
        return super().model_validate(
            cls(
                ...
                channel=cast(MessageSource, obj.channel),
                avatar_url=obj.avatar_url,
                closed_at=obj.closed_at,
                assigments=[
                    AssigmentOutSchema.model_validate(ass) for ass in obj.assigments
                ],
            ).model_dump(),
            strict=strict,
            extra=extra,
